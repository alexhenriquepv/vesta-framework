...
from tasks.ActionTasks.send_push_notification import send_push_notification
from tasks.ActionTasks.turn_alarm_on import turn_alarm_on
from tasks.ProcessingTasks.processing_task import ProcessingTask


class MovementDetectionProcessingTask(ProcessingTask):
